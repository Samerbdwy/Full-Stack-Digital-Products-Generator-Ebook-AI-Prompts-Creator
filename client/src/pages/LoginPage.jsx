...
const LoginPage = () => {
  ...
  return (
    <motion.div
      ...
      className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-500 to-indigo-600 p-4"
    >
      <motion.div
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          >
            ...
            <input
              ...
              autoComplete="email"
              required
              className="w-full px-4 py-2 mt-1 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
              value={email}
